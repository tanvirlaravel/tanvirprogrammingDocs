...
<h1 class="mb-4 mt-1 text-primary heding-one">Type hinting</h1>
    <hr id="top-heading">
<div class="row">
    <div class="col-3">
    ...
    <div class="col-9">
     <h2>Introduction</h2>
     <p>With Type hinting we can specify the expected data type (arrays, objects, interface, etc.) for an argument in a function declaration</p>
     <p>This practice can be most advantageous because it results in  better code organization and improved error messages.</p>
        <hr>
